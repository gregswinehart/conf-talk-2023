...
# {background-color="#17212B" background-image="images/bg-dark.png" background-size="contain" color="white" style="margin-top:-100px;" .smaller}
:::: {.columns }
...
- [Presentation repo](google.com)
- [Quarto variables](google.com)
- [bslib's boostrap variables](google.com)
- [revealjs variables](google.com)
